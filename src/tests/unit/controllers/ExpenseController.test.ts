...
describe('ExpensesController.create', () => {
    it('shoul create a new expense', async () => {
        const expenseMock = {
            save: jest.fn()
        };
    ...
    it('shoul handle expense creation error', async () => {
        const expenseMock = {
            save: jest.fn()
        };
...
describe('ExpensesController.getById', () => {
    it('shoul return expense with ID 1', async () => {
        const req = createRequest({
            method: 'GET',
...
describe('ExpensesController.deleteById', () => {
    it('should delete expense and return a success message', async () => {
        ...
        const data = res._getJSONData()
        expect(res.statusCode).toBe(200)
        expect(data).toEqual("Expense deleted")
