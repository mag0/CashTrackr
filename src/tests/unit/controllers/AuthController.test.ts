...
describe('AuthController.login', () => {
    ...
    it('should return 401 if the password is incorrect', async () => {
        ...
        (checkPasswords as jest.Mock).mockResolvedValue(false);
        ...
        expect(checkPasswords).toHaveBeenCalledWith(req.body.password, userMock.password)
        expect(checkPasswords).toHaveBeenCalledTimes(1)
    })
    ...
    it('should return a JWT if authentication is successful', async () => {
        ...
        (User.findOne as jest.Mock).mockResolvedValue(userMock);
        (checkPasswords as jest.Mock).mockResolvedValue(true);
        ...
        expect(data).toEqual({ token: fakejwt })
